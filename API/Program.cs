...
builder.Services.AddSwaggerGen(options =>
{
    options.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
    {
        ...
        Description = "Insira o token JMT aqui."
    });
...
app.MapPost("/Administradores", ([FromBody] AdministradorDTO administradorDTO, IAdministradorServico administradorServico) =>
{
    ...
    if (string.IsNullOrEmpty(administradorDTO.Email))
        validacao.Mensagens.Add("É obrigatorio inserir o email.");
    if (string.IsNullOrEmpty(administradorDTO.Senha))
        validacao.Mensagens.Add("É obrigatorio inserir a senha.");
    if (administradorDTO.Perfil == null)
        validacao.Mensagens.Add("É obrigatorio inserir o perfil.");
...
ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO)
{
    ...
    if (string.IsNullOrEmpty(veiculoDTO.Nome))
        validacao.Mensagens.Add("É obrigatorio o modelo do veiculo.");
    if (string.IsNullOrEmpty(veiculoDTO.Marca))
        validacao.Mensagens.Add("É obrigatorio a marca do veiculo.");
    if (veiculoDTO.Ano < 1950)
        validacao.Mensagens.Add("O ano não pode ser mais antigo que 1990.");
    return validacao;
}
